...
component {
	...
	// Module Properties
	this.title 				= "Vaultinator";
	this.author 			= "https://michaelborn.me";
	this.webURL 			= "";
	this.description 		= "Security module for BadApple Corp";
	this.version			= "1.0.0";
	...
	// Module Entry Point
	this.entryPoint			= "Vaultinator";
	// Inherit Entry Point
	this.inheritEntryPoint 	= false;
	// Model Namespace
	this.modelNamespace		= "Vaultinator";
	// CF Mapping
	this.cfmapping			= "Vaultinator";
	// Auto-map models
